...
def vgg16_bn(pretrained=False, progress=True, **kwargs):
    """Use torchvision weights (no hardcoded local paths)."""
    import torchvision
    try:
        from torchvision.models import VGG16_BN_Weights
        weights = VGG16_BN_Weights.DEFAULT if pretrained else None
        return torchvision.models.vgg16_bn(weights=weights, progress=progress, **kwargs)
    except Exception:
        return torchvision.models.vgg16_bn(pretrained=pretrained, progress=progress, **kwargs)
