...
if version.parse(torchvision.__version__) < version.parse('0.7'):
    # old torchvision compat
    from torchvision.ops import _new_empty_tensor
    from torchvision.ops.misc import _output_size
else:
    # newer torchvision: provide safe fallbacks if needed
    try:
        from torchvision.ops.misc import _new_empty_tensor, _output_size
    except Exception:
        ...
        def _output_size(dim, input, size, scale_factor):
            ...
            return [int(input.size(i + 2) * scale_factor[i]) for i in range(dim)]
